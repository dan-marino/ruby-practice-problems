...
class PokerHand
  ...
  def two_pair?
    cards.count { |card| cards.count(card) == 2 } == 4
  end

  def pair?
    cards.count { |card| cards.count(card) == 2 } == 2
  end
end
...
# Ace-low (A, 2, 3, 4, 5) straights. For simplicity, your code only 
# needs to recognize Ace-high straights.
